      ...
      <tbody class="text-center">
        <tr>
            ...
            <?php
                ...
                echo "<td><a href='../post.php?read_id=$post_id'> $post_title</a></td>";  
                echo "<td><img style='width: 110px; height: 60px;' src='../common/images/$post_image'></td>";   
                ...
                if($post_author == $post_author_name) {
                    ...
                    echo "<td><a href='posts.php?delete=$post_id' onClick=\"javascript: return confirm('Are you sure you want to delete this post?'); \" class='btn btn-danger glyphicon glyphicon-trash'></a></td>";
                    ...
                    echo "<td><button disabled class='btn btn-warning glyphicon glyphicon-pencil'></button></td>";
                    echo "<td><button disabled class='btn btn-warning glyphicon glyphicon-trash'></button></td>";
                }
