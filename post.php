        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                if ($post_status == 'published') {
                    ...
                    $post_viws_query = "UPDATE posts SET post_views_count = $post_views_count WHERE post_id = $read_id";
                    $post_views_result = mysqli_query($connection, $post_viws_query);
                ...
                <div class="well">
                    ...
                    <form action="" method="post" role="form">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input name="comment_author_name" type="name" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label>Email</label>
